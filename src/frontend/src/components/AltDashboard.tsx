...
import { Task, MealSimple, UserStats } from "../types";
...
export function AltDashboard({ progress, stats, tasks, meals, onOpenRecord, onOpenSuggestions, onOpenWeekly, onOpenEditPlan }: DashboardProps) {
  return (
